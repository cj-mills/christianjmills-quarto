...
![unity-hub-new-project-select-unity-version](../images/icevision-openvino-unity-tutorial/part-3/unity-hub-new-project-select-unity-version.png)
...
![unity-hub-new-project-select-2D-template](../images/icevision-openvino-unity-tutorial/part-3/unity-hub-new-project-select-2D-template.png)
...
![unity-hub-new-project-name-project](../images/icevision-openvino-unity-tutorial/part-3/unity-hub-new-project-name-project.png)
...
![unity-hub-new-project-click-create-project](../images/icevision-openvino-unity-tutorial/part-3/unity-hub-new-project-click-create-project.png)
...
![unity-create-plugins-folder](../images/icevision-openvino-unity-tutorial/part-3/unity-create-plugins-folder.png)
...
![unity-openvino-plugins-folder](../images/icevision-openvino-unity-tutorial/part-3/unity-openvino-plugins-folder.png)
...
![unity-openvino-models-folder](../images/icevision-openvino-unity-tutorial/part-3/unity-openvino-models-folder.png)
...
![unity-open-project-settings](../images/icevision-openvino-unity-tutorial/part-3/unity-open-project-settings.png)
...
![unity-allow-unsafe-code](../images/icevision-openvino-unity-tutorial/part-3/unity-allow-unsafe-code.png)
...
![unity_scripting_symbol_in_editor](../images/icevision-openvino-unity-tutorial/part-3/unity_scripting_symbol_in_editor.png)

If we check if we are not in the Unity Editor, it returns false, and the code block does not execute.

![unity_scripting_symbol_not_in_editor](../images/icevision-openvino-unity-tutorial/part-3/unity_scripting_symbol_not_in_editor.png)
...
![unity-verify-initializeonload](../images/icevision-openvino-unity-tutorial/part-3/unity-verify-initializeonload.png)
